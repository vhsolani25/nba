...
import ImagesIndex from "../components/cruds/Images/Index.vue";
import ImagesCreate from "../components/cruds/Images/Create.vue";
import ImagesShow from "../components/cruds/Images/Show.vue";
import ImagesEdit from "../components/cruds/Images/Edit.vue";
...
const routes = [
    ...
    { path: "/images", component: ImagesIndex, name: "images.index" },
    { path: "/images/create", component: ImagesCreate, name: "images.create" },
    { path: "/images/:id", component: ImagesShow, name: "images.show" },
    { path: "/images/:id/edit", component: ImagesEdit, name: "images.edit" }
];
